...
public class CryptoRSA {
	public static void main(String[] args) {
		...
		String encryptoText = cr.encryto(text, keyPair.get("publicKey"));
	...
	public String encryto(String text, String publicKey) {
	...
	public String decrypto(String encryptoText, String privateKey) {
		...
		try {
			KeyFactory kf = KeyFactory.getInstance("RSA");
			byte[] bytePublicKey = Base64.getDecoder().decode(privateKey.getBytes());
			PKCS8EncodedKeySpec privateKeySpec = new PKCS8EncodedKeySpec(bytePublicKey);
